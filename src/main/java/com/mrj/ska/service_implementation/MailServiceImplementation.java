...
import com.mrj.ska.service.MailService;
...
public class MailServiceImplementation implements MailService {
	...
	public void sendOtp(String toMail, String otp) throws MessagingException {
		...
		String htmlContent = "<html>"
				...
				+ "<h1 style='margin: 0; font-size: 30px; font-weight: 700;'>Smart Kitchen App</h1>" + closingDiv
				...
				+ "<p style='margin: 0;'>Yours truly,<br>Team Smart Kitchen App</p>" + closingDiv
